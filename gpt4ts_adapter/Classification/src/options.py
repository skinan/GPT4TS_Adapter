...
class Options(object):
    def __init__(self):
        ...
        self.parser.add_argument(
            "--adapter_layer", type=int, default=2, help="adapter_layer"
        )
        self.parser.add_argument(
            "--spect_adapter_layer", type=int, default=2, help="spect_adapter_layer"
        )
        ...
        self.parser.add_argument(
            "--adapter_dim", type=int, default=32, help="adapter_dim"
        )
        self.parser.add_argument(
            "--adapter_dropout", type=float, default=0.1, help="adapter dropout"
        )
        ...
        self.parser.add_argument(
            "--output_dir",
            default="/home/muhammadinan/Documents/GitHub/GPT4TS_Adapter/Classification/output",
            help="Root output directory. Must exist. Time-stamped directories will be created inside.",
        )
        self.parser.add_argument(
            "--data_dir",
            default="/home/muhammadinan/Documents/GitHub/GPT4TS_Adapter/Classification/data/Univariate_ts/Adiac",
            help="Data directory",
        )
        ...
        self.parser.add_argument(
            "--optimizer", choices={"Adam", "RAdam"}, default="RAdam", help="Optimizer"
        )
        self.parser.add_argument(
            "--lr",
            type=float,
