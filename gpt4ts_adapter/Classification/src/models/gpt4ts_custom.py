...
from gpt4ts_adapter.Classification.src.models.hugging_gpt2.GPT2 import GPT2Model
from transformers.models.gpt2.configuration_gpt2 import GPT2Config
from transformers import BertTokenizer, BertModel
from einops import rearrange
from gpt4ts_adapter.Classification.src.models.embed import (
    DataEmbedding,
...
class gpt4ts(nn.Module):
    def __init__(self, config):
        ...
        self.num_classes = config["num_targets"]  # len(data.class_names)
